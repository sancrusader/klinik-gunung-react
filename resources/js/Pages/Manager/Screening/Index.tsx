                    ...
                    <Table>
                        ...
                        <TableHeader>
                            <TableRow>
                                ...
                                <TableHead>Dicek Oleh</TableHead>
                            </TableRow>
                        </TableHeader>
                                    ...
                                    <TableRow key={screening.id}>
                                        ...
                                        <TableCell>
                                            ...
                                            {screening.health_check_result ? (
                                                <Badge variant="destructive">{screening.health_check_result}</Badge>
                                        ...
                                        <TableCell>
                                        {screening.paramedis && screening.paramedis.name ? (

                                            <Badge>{screening.paramedis.name}</Badge>
                                        ) : (
                                            <p>Belum Di Cek</p>
                                        )}
                                    </TableCell>
